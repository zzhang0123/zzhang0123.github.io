...
As Nick's last student, I understand his wishes and the value of his lectures. But I hope I won't be his last student, so I'm sharing all of his lecture materials with you. This is the online archive of Nick's lectures and I will do my best to maintain these notes.
</div>
...
<div href="{{ project.url | relative_url }}" class="button button--large"> {{ project.title }}
</div>
</div>
